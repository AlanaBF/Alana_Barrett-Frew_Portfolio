    ...
    return (
        <Container>
            ...
            <div id="main-container" class="container-fluid">
                <div class="row">
                    <div className="col-3 skill">How to create a professional project portfolio</div>
                    <div className="col-3 skill">Team collaboration</div>
                    <div className="col-3 skill">Agile development Methodologies</div>
                    <div className="col-3 skill">Project demonstration and storytelling</div>
                    <div className="col-3 skill">Prince 2 Foundation and Practitioner</div>
                    <div className="col-3 skill">AgilePM Foundation and Practitioner</div>
                    <div className="col-3 skill">User experience design </div>
                    <div className="col-3 skill">HTML/CSS/Git</div>
                    <div className="col-2 skill">JavaScript</div>
                    <div className="col-2 skill">Bootstrap</div>
                    <div className="col-2 skill">The DOM</div>
                    <div className="col-3 skill">APIs</div>
                    <div className="col-3 skill">JQuery</div>
                    <div className="col-2 skill">JSON</div>
                    <div className="col-2 skill">AJAX</div>
                    <div className="col-2 skill">Node.js</div>
                    <div className="col-3 skill">ES6</div>
                    <div className="col-3 skill">Object-orientated programming</div>
                    <div className="col-4 skill">Test-Driven development</div>
                    <div className="col-2 skill">React</div>
                    <div className="col-3 skill">Behavior-driven development</div>
                    <div className="col-3 skill">Deployment</div>
                </div>
            </div>
        </Container>
    )
